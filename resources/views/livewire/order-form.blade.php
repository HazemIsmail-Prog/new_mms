<div class="card">
    ...
    <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select wire:model.lazy="phone_id"
                                class="form-control @error('phone_id') is-invalid @enderror"
                        >
        ...
        <div class="card shadow">
            <div class="card-body row">
                ...
                <div class="form-group col-md-6">
                    <label
                        for="estimated_start_date">@lang('messages.estimated_start_date')</label>
                    ...
                    @error('estimated_start_date')<span
                        class="small text-danger">{{ $message }}</span>@enderror
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    @error('order_description')<span class="small text-danger">{{ $message }}</span>@enderror
                </div>

                <div class="form-group col-md-6">
                    <label for="notes">@lang('messages.notes')</label>
                    <textarea wire:model.lazy="orderNotes" id="notes"
                                class="form-control @error('orderNotes') is-invalid @enderror"></textarea>
                    @error('orderNotes')<span class="small text-danger">{{ $message }}</span>@enderror
                </div>
            </div>
        </div>
    ...
    <div class="card-footer text-center">
        ...
        @if (!$order)
        {{-- create --}}
        <a href="{{route('customers.index')}}" class="btn btn-ghost-danger"
            type="button">@lang('messages.back')</a>
        @else
        {{-- edit --}}
        <a href="{{route('orders.index')}}" class="btn btn-ghost-danger"
            type="button">@lang('messages.back')</a>
        @endif
    </div>
</div>
