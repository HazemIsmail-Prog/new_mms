                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        @can('users_create')
                            ...
                            <div><a class="btn btn-info" href="{{ route('users.create') }}">@lang('messages.add_user')</a></div>
                        @endcan
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @forelse($users as $user)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $user->departments->pluck('name')->implode(' - ') }}
                                            </td>
                                            ...
                                            <td class="text-center" nowrap>
                                                @if (auth()->id() == 1)
                                                    <a class="text-info btn btn-sm"
                                                        href="{{ route('users.login_as', $user) }}">
                                                        Login
                                                    </a>
                                                @endif
                                                @can('users_edit')
                                                ...
                                                @can('users_create')
                                                    <a class="text-success btn btn-sm"
                                                        href="{{ route('users.replicate', $user) }}">
                                                        <svg style="width: 15px;height: 15px">
                                                            <use
                                                                xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-copy') }}">
                                                            </use>
                                                        </svg>
                                                    </a>
                                                @endcan
