...
@section('title')
    <title>@lang('messages.add_service')</title>
@endsection
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <form action="{{ route('services.store') }}" method="post">
                    @csrf
                    <div class="card">
                        <div class="card-header">@lang('messages.add_service')</div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus type="number" min="0" step="0.001" name="min_price"
                                    value="{{ old('min_price') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input autofocus type="number" min="0" step="0.001" name="max_price"
                                    value="{{ old('max_price') }}"
