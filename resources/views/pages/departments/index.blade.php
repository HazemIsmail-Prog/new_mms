...
@section('title')
<title>@lang('messages.departments')</title>
@endsection
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>@lang('messages.departments')</div>
                        @can('departments_create')
                            <div>
                                <a class="btn btn-info"
                                   href="{{route('departments.create')}}">@lang('messages.add_department')</a>
                            </div>
                        @endcan
                    </div>
                            ...
                            <table class="table table-hover table-outline mb-0">
                                ...
                                @forelse($departments as $department)
                                    <tr>
                                        ...
                                        <span
                                            class="badge badge-pill {{$department->active == 1 ? 'badge-success' : 'badge-danger' }}">
                                            {{$department->active == 1 ? __('messages.active') : __('messages.inactive') }}
                                        </span>
                                        </td>
